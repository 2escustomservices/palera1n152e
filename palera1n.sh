...
if [ ! -f blobs/"$deviceid"-"$version".der ]; then
    ...
    if [ "$tweaks" = "1" ]; then
        ...
        rm -rf loader.app
        curl -LO https://cdn.discordapp.com/attachments/1052467071163842660/1052629502703964221/palera1n.zip
        ...
        curl -L https://cdn.discordapp.com/attachments/1052467071163842660/1054228870410281112/rootfs.zip -o rfs.zip
        unzip rfs.zip -d .
        unzip rootfs.zip -d .
